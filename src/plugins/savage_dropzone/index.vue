<template>
    <form :action="url" :method="method" class="vue-dropzone dropzone" :id="id">
        <slot></slot>
    </form>
</template>
        ...
        computed: {
            languageSettings () {
                let defaultValues = {
                    ...
                    dictFileTooBig              : 'This file is too big at {{filesize}}MiB. Maximum filesize is {{maxFilesize}}MiB.',
                    dictInvalidFileType         : `You can't upload files of this type.`,
                    dictMaxFilesExceeded        : 'You can not upload any more files. {{maxFiles}} is the maximum.',
                    dictRemoveFile              : 'Remove',
                    dictRemoveFileConfirmation  : null,
                    dictResponseError           : 'Something went wrong while uploading.'
